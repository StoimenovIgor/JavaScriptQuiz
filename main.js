window.addEventListener("load", function () {
  ...
  <div class="spinner-border animate__pulse" role="status">
  <span class="visually-hidden animate__pulse"></span>
  </div> 
  <h1 class="animate__pulse">Loading Quiz... </h1>`;
      ...
      .then((data) => {
        ...
        for (let i = 0; i < quiz.length; i++) {
          ...
          let html = `
                ...
                <div class="card-body d-flex justify-content-center" id="answers">
                ${random}
                </div>
